#!/usr/bin/env bash
# =============================================================================
# functions.sh — Shared helpers for nva-spoke-internet deploy/cleanup scripts.
# Source this file; do not execute directly.
#
# Provides:
#   log             — timestamp-prefixed progress output
#   VM_SKU_CANDIDATES — ordered B-series SKU list
...
# ---------- VM SKU candidates (B-series, preference order) ------------------
# Override before sourcing to test with different SKUs.
VM_SKU_CANDIDATES=(Standard_B2s Standard_B2ms Standard_B1ms)
