...
//
// Frontend: STATIC private IP 10.0.0.68 in snet-ilb (10.0.0.64/26)
...
resource lb 'Microsoft.Network/loadBalancers@2024-05-01' = {
  ...
  properties: {
    ...
    loadBalancingRules: [
      {
        // HA-ports rule: all protocols, all ports — routes hub 0/0 traffic to any NVA
        name: 'ha-ports-rule'
        properties: {
