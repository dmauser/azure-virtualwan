...
**Note:** the provisioning process will take around 75 minutes to complete.
...
az network firewall policy create -g $rg -n $region1-AZFW-Policy --threat-intel-mode Alert --location $region1 --sku $firewalltier --output none
az network firewall policy create -g $rg -n $region2-AZFW-Policy --threat-intel-mode Alert --location $region2 --sku $firewalltier --output none
