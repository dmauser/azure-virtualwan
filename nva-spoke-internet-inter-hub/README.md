...
az vm create --resource-group $rg --location $location1 --name spoke1-nva --size Standard_B1s --nics spoke1-nva-nic  --image Ubuntu2204 --admin-username $username --admin-password $password -o none --only-show-errors
...
az VM create -n Spoke2VM --resource-group $rg --image Ubuntu2204 --admin-username $username --admin-password $password  --size Standard_B1s --nics Spoke2VMNIC --no-wait -o none --only-show-errors
...
az VM create -n Spoke3VM --resource-group $rg --image Ubuntu2204 --admin-username $username --admin-password $password  --size Standard_B1s --nics Spoke3VMNIC --no-wait -o none --only-show-errors
